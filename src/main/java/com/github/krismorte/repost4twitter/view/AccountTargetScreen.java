...
public class AccountTargetScreen extends DefaultJDialog {
    ...
    public static void showTwitterTargetUsers(TwitterAccount account) {
        ...
        if (verifyEmpytFields("enter the user name", txtUserName)) {
            try {
                ...
                if (twitterAccount != null) {
                    AccountTarget target = twitterAccount.getUser(txtUserName.getText().replace("@", ""));
                    if (target != null) {
                        accountTargetDao.doSave(target);
                    } else {
                        showInformationMessage("User not found!");
                    }
                    showTable(accountTargetDao.listByAccount(twitterAccount.getUsername()));
                }
